...
#   alarm_actions   = [aws_autoscaling_policy.scale_up.arn , aws_sns_topic.infra_update.arn]
# }
...
#   }
#   actions_enabled = true
#   alarm_actions   = [aws_autoscaling_policy.scale_down.arn, aws_sns_topic.infra_update.arn]
  
# }


# # Autoscaling Notifications SNS - Topic
# resource "aws_sns_topic" "infra_update" {
#   name = "infra_update"
# }

# ## SNS - Subscription
# resource "aws_sns_topic_subscription" "demo_subscription" {
#   topic_arn = aws_sns_topic.infra_update.arn
#   protocol  = "email"
...
#   group_names = [aws_autoscaling_group.asg_name.id]
#   notifications = [
